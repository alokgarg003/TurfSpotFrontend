...
function LoginManager() {
  ...
  const handleLogin = async (e) => {
    ...
    setIsLoading(true);
    try {
      await dispatch(ManagerLoginAction(loginState));
    } catch (error) {
  ...
  if (userSignIn) return <Redirect to="/profile/manager" />;
        ...
        <Grid container spacing={4} alignItems="center">
            ...
            <LoginPaper elevation={0}>
              <Box sx={{ textAlign: 'center', mb: 4 }}>
                ...
                <Typography variant="body1" sx={{ color: '#666', mb: 4 }}>
                  Access your management dashboard and control turf operations
                </Typography>
              </Box>
              ...
              <Box sx={{ backgroundColor: 'white', p: 4, borderRadius: 3, boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
                <form onSubmit={handleLogin}>
                  ...
                  <Typography variant="body2" sx={{ textAlign: 'center', color: '#666' }}>
                    Don't have an account?{' '}
                    <Link to="/managerregister" style={{ textDecoration: 'none', color: '#228b22' }}>
                      Register here
                    </Link>
                  </Typography>
                </form>
          ...
          <Grid item xs={12} md={6} sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="h6" sx={{ 
              ...
              Manage your turf facilities efficiently
            </Typography>
            <Box
              component="img"
              src={g1}
